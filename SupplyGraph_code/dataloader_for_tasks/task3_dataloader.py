# Edge-Level Logistics Flow Prediction
import pandas as pd
import numpy as np
from torch.utils.data import Dataset, DataLoader

class EdgeLogisticsDataset(Dataset):
...
# Parameters
window_size = 5
target_column = 'SOS008L02P'  # Example target column in 'Delivery To distributor.csv'
...
# Create datasets
train_dataset = EdgeLogisticsDataset(train_data, edges_combined, window_size, target_column)
val_dataset = EdgeLogisticsDataset(val_data, edges_combined, window_size, target_column)
test_dataset = EdgeLogisticsDataset(test_data, edges_combined, window_size, target_column)
...
print("Data loaders created for edge-level logistics flow prediction.")
